...
class WheaterStation(object):
    ...
    def randomValue(self, sensor_position, range_min, range_max):
        self.sensors[sensor_position] = float("{0:.2f}".format(random.uniform(range_min, range_max)))
...
def main():
    ...
    w1 = WheaterStation(1, 7)
    while(1):
        w1.randomValue(0, 0, 50)    # temperature
        w1.randomValue(1, 0, 50)    # temperature
        w1.randomValue(2, 0, 20)    # windspeed
        w1.randomValue(3, 0, 360)   # winddir
        w1.randomValue(4, 0, 100)   # pressure
        w1.randomValue(5, 0, 1024)  # light
        w1.randomValue(6, 0, 100)   # rain
